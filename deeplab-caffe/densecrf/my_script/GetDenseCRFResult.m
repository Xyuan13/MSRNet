...
dataset='msra'
dataset_path=['/home/phoenix/deeplab/rmt/data/' dataset];
%map_dir = dir(fullfile(map_folder, '*.bin'));
map_folder=[dataset_path '/densecrf_bin'];
map_dir = dir([map_folder '/*bin']);
save_root_folder=[dataset_path '/densecrf_png'];
