...
%
dataset    = 'msra10k' %'PASCALContourData' %'msra';  %'voc12', 'coco'
trainset   = 'train_aug';      % not used
testset    = 'val';            %'val', 'test'

model_name =  'SimplifyModel_Multi' %'deeplab_v2_vgg16' %'Res101' %'deeplab_v2_vgg16';

feature_name = 'features';
feature_type = 'fc8'; % fc8 / crf /fc1(res)
