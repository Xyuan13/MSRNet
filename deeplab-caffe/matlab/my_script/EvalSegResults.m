...
if is_server
  ...
  elseif strcmp(dataset, 'pascalSelect')
    VOC_root_folder = '/rmt/data/pascalSelect';
  else
    error('Wrong dataset');
  end
else
...
save_root_folder = fullfile('/home/phoenix/deeplab/rmt/work/deeplabel/exper', dataset, 'res', feature_name, model_name, testset, feature_type, post_folder);
